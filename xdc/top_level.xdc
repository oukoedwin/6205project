...
set_property -dict {PACKAGE_PIN F14 IOSTANDARD BLVDS_25}  [ get_ports "pmoda[0]" ]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD BLVDS_25}  [ get_ports "pmoda[1]" ]
...
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[0]" ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[1]" ]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[2]" ]
...
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[3]" ]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[4]" ]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[5]" ]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[6]" ]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS25}  [ get_ports "pmodb[7]" ]
