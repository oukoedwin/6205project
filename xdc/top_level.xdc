...
set_property -dict {PACKAGE_PIN H18 IOSTANDARD TMDS_33}  [ get_ports "pmodb[0]" ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD TMDS_33}  [ get_ports "pmodb[1]" ]
...
# set_property -dict {PACKAGE_PIN H16 IOSTANDARD TMDS_33}  [ get_ports "pmodb[4]" ]
